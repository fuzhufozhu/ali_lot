...
3.  在界面右上角单击**分享**。
    -   **授权登录访问**
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/133664/155244272339732_zh-CN.png)
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/133664/155244272339731_zh-CN.png)

    -   **免登录访问**

        该分享方式会生成一个无需登录就能访问的URL，用户通过该URL直接访问已编辑好的二维/三维数据可视化场景，适合需要将二维/三维数据可视化做嵌入集成的用户或企业。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/133664/155244272439733_zh-CN.png)
...
1.  在二维/三维数据可视化**分享**窗口中，复制免登录访问URL和URL的Token。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/133664/155244272440195_zh-CN.png)
