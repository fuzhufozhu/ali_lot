...
您可以在物联网平台上自定义Topic类，设备将消息发送到自定义Topic中，服务端通过HTTP/2 SDK获取设备上报消息；服务端通过调用云端API [Pub](../../../../cn.zh-CN/云端开发指南/云端API参考/消息通信/Pub.md#)向设备发布指令。

## 背景信息 {#section_ict_9m2_51s .section}

本示例中，电子温度计定期与服务器进行数据的交互，传递温度和指令等信息。温度计向服务器上行发送当前的温度；服务器向温度计下行发送精度设置指令。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/341841/156153899948433_zh-CN.png)
...
5.  在产品详情页的Topic类列表页签下，增加自定义Topic类。
    ...
    详细操作指导，请参见[自定义Topic](../../../../cn.zh-CN/用户指南/产品与设备/Topic/自定义Topic.md#)。
...
6.  在服务端订阅页签下，设置HTTP/2通道服务端订阅，订阅**设备上报消息** 。
    ...
    详细操作指导，请参见服务端订阅[开发指南\(Java\)](../../../../cn.zh-CN/用户指南/产品与设备/服务端订阅/开发指南(Java).md#)。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/341841/156153899950122_zh-CN.png)

7.  在左侧导航栏，单击**设备**，然后在刚创建的温度计产品下，添加设备。详细操作指导，请参见[单个创建设备](../../../../cn.zh-CN/用户指南/产品与设备/创建设备/单个创建设备.md#)。

## 设备发送消息给服务器 {#section_1oo_pqf_80d .section}

流程图：

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/341841/156153899948448_zh-CN.png)
...
-   配置服务端HTTP/2 SDK，设置Topic回调。
    ...
    更多具体配置详情，请参见HTTP/2 SDK[开发指南\(Java\)](../../../../cn.zh-CN/用户指南/产品与设备/服务端订阅/开发指南(Java).md#)。
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/341841/156153899948453_zh-CN.png)
