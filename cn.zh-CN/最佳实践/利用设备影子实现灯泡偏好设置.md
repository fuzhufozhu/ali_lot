...
4.  验证是否设置成功。 
    ...
    -   首次开灯，第一次运行。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7643/15629176954223_zh-CN.png)

    -   关灯后，服务端修改灯泡期望颜色，灯泡开灯。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7643/15629176954224_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7643/15629176954225_zh-CN.png)

    -   关灯后再开

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7643/15629176964226_zh-CN.png)
