...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7530/15433071866524_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7530/15433071866525_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7530/15433071866526_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7530/154330718614259_zh-CN.png)

透传/自定义数据格式产品下的物模型数据分析，除了展示日志的内容之外，还会显示设备上报的原始数据的16进制字符串格式内容。如下图所示：

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7530/154330718621256_zh-CN.png)
...
-   服务调用传入的参数格式不正确
 ...
 |参考[API接口文档](../../../../cn.zh-CN/云端开发指南/云端API参考/概述.md#)及TSL，查看服务需要的数据格式。同时参考[Alink协议文档](../../../../cn.zh-CN/设备端开发指南/基于Alink协议开发/Alink协议.md#)，查看对应的数据格式。|
|**系统异常错误码**|
...
|6207|数据的格式错误| 下行同步调用时，或者设备上报数据时出现。
 ...
 |参考[Alink协议文档](../../../../cn.zh-CN/设备端开发指南/基于Alink协议开发/Alink协议.md#)，查看对应数据格式，并按格式要求上报数据。|
|**系统异常错误码**|
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7530/154330718621104_zh-CN.png)
