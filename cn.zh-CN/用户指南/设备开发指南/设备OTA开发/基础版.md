...
-   签名错误，如果设备端获取的固件的url不全或者手动修改了url内容，就会出现如下错误：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13905/15331303643964_zh-CN.png)

-   访问拒绝，URL过期导致，目前过期时间为30分钟。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13905/15331303643967_zh-CN.PNG)
