...
|IotId|String|No| ID of the device whose event records you want to query.
 ...
 **Note:** If you use this parameter, ProductKey is required.
 ...
 |
|EventType|String|No| The type of the event that you want to query. Value options:
...
|StartTime|Long|Yes|The start time of event records that you want to query.|
