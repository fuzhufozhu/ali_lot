...
3.  创建设备，并获取设备证书（ProductKey、DeviceName、DeviceSecret）和地域（RegionId）信息。本示例中，在路灯产品下创建设备Lamp。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134519/155710888139879_zh-CN.png)
...
-   调用[QueryDeviceDesiredProperty](../../../../intl.zh-CN/云端开发指南/云端API参考/设备管理/QueryDeviceDesiredProperty.md#)，查看设备的期望属性值。
...
-   调用[SetDeviceDesiredProperty](../../../../intl.zh-CN/云端开发指南/云端API参考/设备管理/SetDeviceDesiredProperty.md#)，设置期望属性值。
...
设备端开发更多信息请参考[下载设备端SDK](../../../../intl.zh-CN/设备端开发指南/下载设备端SDK.md#)。
...
-   设备在线时，服务端修改灯泡开关状态，灯泡实时响应状态变化。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134519/155710888139883_zh-CN.png)

-   设备不在线时，服务端修改灯泡开关状态，云端期望属性值与设备的最新属性值不一致。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134519/155710888139884_zh-CN.png)

-   设备联网后，设备主动拉取期望属性值，设备的最新属性值实现与云端期望属性值的同步。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134519/155710888139885_zh-CN.png)
